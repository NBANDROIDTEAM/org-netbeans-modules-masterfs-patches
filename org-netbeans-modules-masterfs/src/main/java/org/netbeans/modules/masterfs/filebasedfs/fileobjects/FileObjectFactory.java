...
public final class FileObjectFactory {
     ...
     * according to given expectedExists parameter. If the state is different
     * than expected, it prints warning to console. It can happen when some
     * module doesn't use filesystems API to handle files but directly uses
     * java.io.File.
     *
